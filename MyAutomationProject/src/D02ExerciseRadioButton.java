...
public class D02ExerciseRadioButton {
	...
	public static void main(String[] args) {
		...
		//List<WebElement> products = driver.findElement(By.xpath("html/body/div[2]/table[9]/tbody/tr/td[4]/table/tbody/tr/td/div/span/form/table[3]/tbody/tr/td/table/tbody/tr/td/input"));
		for(WebElement p : products) {
			System.out.println("--------------------------------");
			System.out.println("Before");
			System.out.println(p.getAttribute("valyue") + ": Selected: " + p.isSelected());
